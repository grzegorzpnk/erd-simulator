...
#set title "Number of skipped search [per iteration, per app type]" font 'Helvetica,25'
...
set ylabel "Number of Skipped Search [-]" font 'Helvetica,20'
