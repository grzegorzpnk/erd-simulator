...
set output 'failed-rates.svg'

set arrow 1 from -1,10 to 29,10 nohead lc 'midnight-blue' lw 2  lt 2 dt 9
set arrow 2 from -1,5 to 29,5 nohead lc 'midnight-blue' lw 2  lt 2 dt 9
set arrow 3 from -1,15 to 29,15 nohead lc 'midnight-blue' lw 2  lt 2 dt 9
set arrow 4 from -1,20 to 29,20 nohead lc 'midnight-blue' lw 2  lt 2 dt 9

set boxwidth 0.8 relative
set xtics rotate by 90 offset 0,-5.1
set bmargin 7
...
plot newhistogram "M=1" font 'Helvetica,23' offset 0,4.5, \
