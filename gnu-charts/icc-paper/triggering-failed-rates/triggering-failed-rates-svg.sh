...
set output 'triggering-failed-rates.svg'
...
plot newhistogram "Relocation Triggering Rates" font 'Helvetica,17' offset 0,4.5, \
        'triggering.dat' using 2:xticlabels(1) title "Cloud Gaming" linecolor rgb "black", \
     ...
     newhistogram "Relocation Rejection Rate" font 'Helvetica,17' offset 0,4.5, \
        'failed.dat' using 2:xticlabels(1) title "" linecolor rgb "black", \
