...
set ylabel "Number of Successful Relocations [-]" font 'Helvetica,25'
...
plot newhistogram "M=1" font 'Helvetica,17', \
        ...
        '' using 6:(column(2)+column(3)+column(4)):5 notitle lc 8 lw 2 lt 1 with yerrorbars, \
