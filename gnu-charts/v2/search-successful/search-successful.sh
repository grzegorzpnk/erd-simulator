...
#set title "Number of successful search [per iteration, per app type]" font 'Helvetica,25'
...
set output 'search-successful.eps'
...
set ylabel "Number of Successful Search" font 'Helvetica,20'
