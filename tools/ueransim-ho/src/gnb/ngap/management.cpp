...
int NgapTask::findPduByUeId(int ueId)
{
    ...
    if (!ue->pduSessions.empty()) //todo tutaj moze zwracac wiecej id jesli bedzie wiecej sesji na jednego ue - wziete z context.cpp
    {
