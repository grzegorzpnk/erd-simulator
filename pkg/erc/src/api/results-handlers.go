...
func (h intentHandler) relocationFailedHandler(w http.ResponseWriter, r *http.Request) {

	params := mux.Vars(r)
	h.client.Results.IncFailed(params["type"])
...
func (h *api.apiHandler) relocationRedundantHandler(w http.ResponseWriter, r *http.Request) {
...
func (h *api.apiHandler) relocationSkippedHandler(w http.ResponseWriter, r *http.Request) {
...
func (h *api.apiHandler) failedTimeHandler(w http.ResponseWriter, r *http.Request) {
...
func (h *api.apiHandler) successfulTimeHandler(w http.ResponseWriter, r *http.Request) {
	var body time.Duration
...
func (h *api.apiHandler) redundantTimeHandler(w http.ResponseWriter, r *http.Request) {
	var body time.Duration
...
func (h *api.apiHandler) skippedTimeHandler(w http.ResponseWriter, r *http.Request) {
	var body time.Duration
...
func (h *api.apiHandler) resetHandler(w http.ResponseWriter, r *http.Request) {
...
func (h *api.apiHandler) getResultsHandler(w http.ResponseWriter, r *http.Request) {
...
func (h *api.apiHandler) getResultsCSVHandler(w http.ResponseWriter, r *http.Request) {
	var body []string
	subs := h.resClient.Results
