...
func declareGlobcomExperiments(details model.ExperimentDetails) []model.ExperimentIntent {
	...
	experiments = append(experiments, experiment4)

	return experiments
}

func declareMLComparisonExperiments(details model.ExperimentDetails) []model.ExperimentIntent {
	...
	experiment4 := model.ExperimentIntent{
		ExperimentType:     model.ExpMLMasked,
		ExperimentStrategy: model.StrML2,
		ExperimentDetails:  details,
	}

	experiment5 := model.ExperimentIntent{
		ExperimentType:     model.ExpMLMasked,
		ExperimentStrategy: model.StrML3,
		ExperimentDetails:  details,
	}
