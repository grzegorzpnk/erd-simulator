...
func initializeEmpty2DArray(length int) [][]float64 {
...
set arrow 1 from -1,5 to 3,5 nohead lc 'midnight-blue' lw 2  lt 2 dt 9
set arrow 2 from -1,10 to 3,10 nohead lc 'midnight-blue' lw 2  lt 2 dt 9
set arrow 3 from -1,15 to 3,15 nohead lc 'midnight-blue' lw 2  lt 2 dt 9
...
set arrow 1 from -1,20 to 3,20 nohead lc 'midnight-blue' lw 2  lt 2 dt 9
set arrow 2 from -1,40 to 3,40 nohead lc 'midnight-blue' lw 2  lt 2 dt 9
set arrow 3 from -1,60 to 3,60 nohead lc 'midnight-blue' lw 2  lt 2 dt 9
set arrow 4 from -1,80 to 3,80 nohead lc 'midnight-blue' lw 2  lt 2 dt 9
...
func generateAggregatedRatesScriptMecs(resType, yLabel string, iterFiles []string) string {
...
set arrow 4 from -1,80 to 11,80 nohead lc 'red' lw 2  lt 2 dt 1
...
plot newhistogram "Optimal" font 'Helvetica,17' offset 0,0.7, \
...
exit
`, resType, yLabel, iterFiles[0], iterFiles[1], iterFiles[2])
